...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { age: @user_profile.age, hobbies: @user_profile.hobbies, name: @user_profile.name, starsigin: @user_profile.starsigin }
    end
  ...
  test "should update user_profile" do
    patch :update, id: @user_profile, user_profile: { age: @user_profile.age, hobbies: @user_profile.hobbies, name: @user_profile.name, starsigin: @user_profile.starsigin }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
